...
client.user.setGame("HB HOSTING")
client.user.setStatus("dnd")
});

var statuss = ["hbhosting","hbhosting/fivem","https://discord.gg/kYrykUT","hbhosting.de","zedd-wajih"]; // بالإمكان اضافة المزيد بدون التعديل في الكود
